...
import { getRedeem } from "../../store/Redeem/RedeemAction";
import $ from "jquery";

const RedeemDecline = (props) => {
    ...
    <>
      <div className="row py-2">
        <div class="col-xl-6 col-md-6 col-sm-12 col-12">
          <h4 className="table_title">Redeem Decline </h4>
        </div>
        <div class="col-xl-6 col-md-6 col-sm-12 col-12 ">
...
export default connect(null, { getRedeem })(RedeemDecline);
