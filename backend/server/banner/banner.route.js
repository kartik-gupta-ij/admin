...
route.post("/", upload.single("image"), checkAccessWithSecretKey(), BannerController.store);

//Get Banner Category [Backend]
route.get("/", checkAccessWithSecretKey(), BannerController.index);

//Update Banner Category [Backend]
route.patch("/", upload.single("image"), checkAccessWithSecretKey(), BannerController.update);
