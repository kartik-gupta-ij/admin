...
exports.store = async (req, res) => {
  try {
    ...
    function _0x44a9() {
      const _0x7ff6de = ["2561480lZecPm", "6603222WogeqV", "body", "33IvdUWK", "7989156LzhJKQ", "code", "Tindo", "145828PxCXpb", "612304eUUNMu", "12834904yijRAK", "646236qIFGVt", "9pvgDZk"];
      _0x44a9 = function () {
        return _0x7ff6de;
      };
      return _0x44a9();
...
exports.login = async (req, res) => {
  try {
    ...
    function _0x2deb() {
      const _0x3c00c9 = ["1918264bmYBcW", "2537204PvqTMB", "24VrBHIP", "2106785BHAZCF", "Tindo", "7356642cJmJMC", "5096420HSiBzb", "4203042CPHreB", "30205eVQoMe", "9lfrNDq", "purchaseCo"];
      _0x2deb = function () {
        return _0x3c00c9;
      };
      return _0x2deb();
...
exports.update = async (req, res) => {
  try {
    const admin = await Admin.findById(req.admin._id);
    if (!admin) {
      return res.status(200).json({ status: false, message: "Admin doesn't Exist." });
    }
